...
def accepted():
    messagebox.showinfo('MEU AMOR', 'EU TE AMO, ME LIGA')
...
text_id = Label(root, bg='#ffc8dd', text='QUER VOLTAR COMIGO?', fg='#590d22', font=('Montserrat', 24, 'bold'))
text_id.pack()
